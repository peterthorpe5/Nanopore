...
fmlrc -V -p 24 -K 45 -m 2 comp_msbwt.npy all_direct_RNA_Newton_reads_U_for_T.fasta all_direct_RNA_Newton_reads.error_corr.fasta

fmlrc -V -p 24 -K 45 -m 2 comp_msbwt.npy all_direct_RNA_Newton_reads_run2_U_for_T.fasta all_direct_RNA_Newton_reads_run2.error_corr.fasta
