...
bwa mem -t $THREADS  lindley_nanopore_run2_xont_S1_A.cns_raw.fa R1_paired.fq R2_paired.fq > new.illumina.mapped.sam
...
# this has been through one iteration. Now use the ouptu from iteration 1 for the new error correction. 
pilon --genome lindley_nanopore_run2_xont_S1_A.cns_raw.fa --bam new.illumina.mapped.bam --changes --vcf --diploid --threads $THREADS --output lindley_pilon_iter2
...
bwa index lindley_pilon_iter2.fasta
bwa mem -t $THREADS lindley_pilon_iter2.fasta R1_paired.fq R2_paired.fq > new.illumina.mapped.sam
...
# this has been through one iteration. Now use the ouptu from iteration 1 for the new error correction. 
pilon --genome lindley_pilon_iter2.fasta --bam new.illumina.mapped.bam --changes --vcf --diploid --threads $THREADS --output lindley_pilon_iter3
...
bwa index lindley_pilon_iter3.fasta
bwa mem -t $THREADS lindley_pilon_iter3.fasta R1_paired.fq R2_paired.fq > new.illumina.mapped.sam
...
# this has been through one iteration. Now use the ouptu from iteration 1 for the new error correction. 
pilon --genome lindley_pilon_iter3.fasta --bam new.illumina.mapped.bam --changes --vcf --diploid --threads $THREADS --output lindley_pilon_iter4
