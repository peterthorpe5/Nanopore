...
current_path="/storage/home/users/pjt6/for_seb/gros/"
species="gr_gr"
...
cd ${species}
##################################################################################
#python reform_gff.py --gff *.gff* -s gr -o ${species}.gff
#cp ./${species}.gff ./${species}/${species}.gff
#conda activate python27
#
## pre filter the amino acid file for .t1 codings, only. Then remove the .t1 from the name.
#python get_names_of_seq.py *.protein.fa ${species}.aa.fa
#
##python get_names_of_seq.py *.protein.fa ${species}.aa.fa
#diamond makedb --in ${species}.aa.fa -d ${species}
#diamond blastp -p 4 --more-sensitive -e 1e-5 -v -q ${species}.aa.fa  -d ${species}.dmnd --outfmt 6 -o ${current_path}/${species}_1eminus5.blast
...
do
    ...
    echo ${mcscancmd}
    eval ${mcscancmd}
    mv ${species}.html ${species}_${evalue}.html
    ...
    -d /storage/home/users/pjt6/for_seb/gros/grosnt.fa
